        ...
        methods: {
            ...
            getBalanceForWallet() {
                ...
                storage.getAll(function(error, data) {
                    ...
                    _this.$http.get(`${window.nodeHost}/node/state/account/${address}/$@`, {
                    headers : {
            ...
            updateAllBalances() {
                ...
                storage.getAll(function(error, data) {
                    ...
                    for (let i = 0; i < wallets.length; i++) {
                        ...
                        _this.$http.get(`${window.nodeHost}/node/state/account/${urlAddress}/$@`, {
                        headers : {
                            'Content-Type': 'application/json; charset=UTF-8',
                            'Accept': 'application/json'
                        }
            ...
            getTransactionsForWallet() {
                this.$http.get(`${window.nodeHost}/wallets/${this.selectedWallet.replace(/\//g,"\%2F")}/transactions/list`, {
                headers : {
                    'Content-Type': 'application/json; charset=UTF-8',
                    'Accept': 'application/json'
                }
